...
public:
    CMainParams() {
        ...
        // nBits: 0x1e200000 = easiest safe difficulty (calibrated for 60s blocks with 10 miners at ~1kH/s each)
        // nVersion: 0x20000000 = BIP9 enabled from genesis
        // Note: nNonce will need to be mined for final launch; using placeholder
        genesis = CreateBotcoinGenesisBlock(1738195200, 0, 0x1e200000, 0x20000000, 50 * COIN);
...
public:
    CTestNetParams() {
        ...
        genesis = CreateBotcoinGenesisBlock(1738195200, 1, 0x1e200000, 0x20000000, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
...
public:
    CTestNet4Params() {
        ...
        genesis = CreateBotcoinGenesisBlock(1738195200, 2, 0x1e200000, 0x20000000, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        // TODO: Assertions updated after genesis mining
...
public:
    explicit SigNetParams(const SigNetOptions& options)
    {
        ...
        genesis = CreateBotcoinGenesisBlock(1738195200, 3, 0x1e200000, 0x20000000, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        // TODO: Assertions updated after genesis mining
...
public:
    explicit CRegTestParams(const RegTestOptions& opts)
    {
        ...
        // nBits: 0x1e200000 = very easy target for testing
